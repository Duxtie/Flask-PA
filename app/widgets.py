...
from etas.app import get_template
...
class FormWidget(RenderTemplateWidget):
    ...
    template = get_template() + "/general/widgets/form.html"
...
class FormVerticalWidget(RenderTemplateWidget):
    ...
    template = get_template() + "/general/widgets/form_vertical.html"
...
class FormHorizontalWidget(RenderTemplateWidget):
    ...
    template = get_template() + "/general/widgets/form_horizontal.html"
...
class FormInlineWidget(RenderTemplateWidget):
    ...
    template = get_template() + "/general/widgets/form_inline.html"


class GroupFormListWidget(RenderTemplateWidget):
    template = get_template() + "/general/widgets/group_form_list.html"


class SearchWidget(FormWidget):
    template = get_template() + "/general/widgets/search.html"
    filters = None
...
class ShowWidget(RenderTemplateWidget):
    ...
    template = get_template() + "/general/widgets/show.html"


class ShowBlockWidget(RenderTemplateWidget):
    template = get_template() + "/general/widgets/show_block.html"


class ShowVerticalWidget(RenderTemplateWidget):
    template = get_template() + "/general/widgets/show_vertical.html"
...
class ListMasterWidget(ListWidget):
    template = get_template() + "/general/widgets/list_master.html"


class ListAddWidget(ListWidget):
    template = get_template() + "/general/widgets/list_add.html"
...
class ListThumbnail(ListWidget):
    template = get_template() + "/general/widgets/list_thumbnail.html"


class ListLinkWidget(ListWidget):
    template = get_template() + "/general/widgets/list_link.html"


class ListCarousel(ListWidget):
    template = get_template() + "/general/widgets/list_carousel.html"


class ListItem(ListWidget):
    template = get_template() + "/general/widgets/list_item.html"


class ListBlock(ListWidget):
    template = get_template() + "/general/widgets/list_block.html"
